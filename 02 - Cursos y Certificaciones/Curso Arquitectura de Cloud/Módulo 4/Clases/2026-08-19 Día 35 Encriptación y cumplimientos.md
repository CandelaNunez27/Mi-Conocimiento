...
- **Cifrado Asimétrico:** son dos claves una privada y una publica, usada para ssh. Se genera un cifrado generando una privada y una publica, se podria decir que para acceder se debe pasar por dos candados, primero la publica que es para que viaje cifrada y luego la privada para cuando llegue la publica se pueda descifrar con la privada. Ej tengo un malentin con doble candado y  viene una persona diciendo que el primer candado es 001 (la clave publica) por ende el candado abre, uno al ver que la persona puso correctamente la publica yo sin mostrarle la privada le abro el segundo candado con 002 (la clave privada)
