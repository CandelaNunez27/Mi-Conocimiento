...
- **Concepto:** La entrada de datos es el mecanismo por el cual un programa recibe información del mundo exterior (generalmente del usuario a través del teclado) para procesarla. Esto hace que los programas sean interactivos y dinámicos, ya que no siempre trabajan con valores fijos predefinidos en el código.
...
- **Concepto:** Los bucles (o ciclos) son estructuras que te permiten repetir un bloque de código múltiples veces sin tener que escribirlo una y otra vez. Se basan en una condición lógica.
...
- **Concepto:** A diferencia de una variable normal que guarda un solo valor, un conjunto de datos permite almacenar múltiples valores bajo un mismo nombre.
    
- **Listas / Arreglos (Arrays):** Son colecciones ordenadas de datos. Puedes guardar números, textos, booleanos e incluso otras listas dentro de ellas.
